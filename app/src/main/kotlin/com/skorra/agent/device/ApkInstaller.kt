...
class ApkInstaller(private val ctx: Context, config: AgentConfig) {
    ...
    private fun downloadTo(url: String, dest: File, onProgress: (Int) -> Unit) {
    ...
    private fun commitInstall(apk: File): Result {
    ...
    companion object {
        private const val ACTION_INSTALL_RESULT = "com.skorra.agent.INSTALL_RESULT"
    }
}
